...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        #
        self.connectButton = tk.Button(self.groupCon,bg='green',
        ...
        padder.pack(side="left")
        #
        self.clearButton = tk.Button(self.groupCon, bg='yellow',text='clear',
        ...
        padder.pack(side="left")
        #
        self.sendButton = tk.Button(self.groupSend, bg='lightblue',text = 'send',
